      ...
      >
        <div className="flex flex-col xl:flex-row bg-white p-8 rounded-xl min-h-[394px] xl:p10 xl:-translate-y-32 xl:gap-x-12">
          <div className="xl:w-[470px] mb-6 xl:mb-0">
            ...
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Odio reiciendis quasi et porro ducimus facilis, earum eos in dignissimos nesciunt nihil molestias laboriosam, </p>
          </div>
          <div className="flex xl:gap-x-16 xl:ml-32 ">
         
            <div className="flex-1">
              <h4 className="h4 mb-6">Contact Us</h4>
              <ul className="flex flex-col gap-y-6 text-lg"><li>
                  <Link href='/'>Home</Link>
                </li>
                <li>
